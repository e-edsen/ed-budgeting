...
import type { DashboardDto, DashboardUserConfigDto } from '../contracts/dashboard';

export interface BuildDashboardDtoParams {
  clientTimezone: string | null;
  clientOffsetMinutes: number | null;
  config: DashboardUserConfigDto;
  fxState: FxState;
  now?: Date;
  runtimeConfig?: typeof DASHBOARD_RUNTIME_CONFIG;
}
...
export function buildDashboardDto({
...
}: BuildDashboardDtoParams): DashboardDto {
  ...
  return {
    ...
    config: {
      ...
      fxRefreshMs: runtimeConfig.fxRefreshMs,
